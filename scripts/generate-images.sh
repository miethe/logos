...
#
# Inspired by the browser-logo repo - https://github.com/alrra/browser-logos/blob/main/scripts/generate-images.sh
...
declare -r -a MAIN_OCP_RH_INTEGRATIONS=(
    "ocp-pipelines"
    "ocp-serverless"
)

declare -r -a MAIN_OCP_INTEGRATIONS=(
    "tekton"
    "argocd"
    "knative"
)
